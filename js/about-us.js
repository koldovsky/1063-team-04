const services = [
  {
    imageSvg: (
      <svg
        ...
        y="0px"
        viewBox="0 0 100 100"
        style="enable-background:new 0 0 100 100;max-width:100%"
        xml:space="preserve"
        height="100%"
      >
        <switch style="" fill="currentColor">
          <foreignObject
            ...
            fill="currentColor"
          ></foreignObject>
          <g i:extraneous="self" style="" fill="currentColor">
  ...
  },
  {
    imageSvg: (
      <svg
        ...
        y="0px"
        viewBox="0 0 60 60"
        style="enable-background:new 0 0 60 60;max-width:100%"
        xml:space="preserve"
        height="100%"
      >
        <g style="" fill="currentColor">
          <g style="" fill="currentColor">
            <path
              d="M9,49h42c2.8,0,5-2.2,5-5V16c0-2.8-2.2-5-5-5H9c-2.8,0-5,2.2-5,5v28C4,46.8,6.2,49,9,49z M51,47H9c-1.7,0-3-1.3-3-3V28h48    v16C54,45.7,52.7,47,51,47z M9,13h42c1.7,0,3,1.3,3,3v4H6v-4C6,14.3,7.3,13,9,13z"
              style=""
              fill="currentColor"
            ></path>
            <path
...
function renderServices() {
  ...
  for (const service of services) {
    servicesHtml += `<article class="about-us__service-card">
